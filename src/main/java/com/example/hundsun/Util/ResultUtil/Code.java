package com.example.hundsun.Util.ResultUtil;

public class Code {
    //正确形式
    public static final Integer POST_OK = 1001;
    public static final Integer DELETE_OK = 1002;
    ...
    //错误形式
    public static final Integer POST_ERR = 2001;
